...
{
   public const string RootEndpoint = "https://www.handyfeeling.com/api/handy-rest/v3/";
   public const string AccessTokenEndpoint = $"{RootEndpoint}auth/token/issue";
   ...
   public const string SlideEndpoint = $"{RootEndpoint}slider/stroke";
